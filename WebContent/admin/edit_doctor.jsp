		...
		<div class="row">
			...
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-3 text-center">Modifier les informations d'un Docteur</p>
						...
						<form action="../updateDoctor" method="post">
							<div class="mb-3">
								<label class="form-label">Nom Complet</label> <input type="text"
							...
							<div class="mb-3">
								<label class="form-label">Spécialité</label> <select name="spec"
